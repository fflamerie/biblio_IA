...
![Techniques utilisées dans l'IA générative - [@miao2024OrientationsPour]](img/IA_rappels_Unesco.png)

:::aside
Voir aussi : ["Fonctionnement des IA" dans le cours d'A. Bouchard](https://callisto-formation.fr/course/view.php?id=952#module-22173)
:::
...
Les résultats de ces tests sont [dans le dossier **tests_IA_reecriture** sur le dépôt GitHub du stage > fichier **Test_rewrite_Reponses_ChatGPT_APA_PUR.odt**](https://github.com/fflamerie/biblio_IA/tree/main/docs/tests_IA_reecriture) ; ce dossier contient également les bibliographies PUR et APA7 créées avec Zotero.
...
-   Les coller dans une instruction ChatGPT formulée par exemple ainsi : "pourrais-tu convertir les 15 références bibliographiques ci-dessous au format BibTex?", puis importer les références au format BibTeX dans Zotero.
...
::::: columns
::: {.column width="60%"}
-   Instructions de **recherche** et d’**analyse**.
...
## ARIA : bibliothèque d'instructions

::::: columns
::: {.column width="40%"}
Fournir du contexte dans les instructions avec :
...
::: {.column width="60%"}
![Fenêtre d'accueil d'ARIA : la bibliothèque d'instructions](img/ARIA_menu.png)
:::
:::::

## ARIA : instruction de recherche
...
::: {.column width="60%"}
![Saisie d'une question avec l'instruction *Search your library*](img/ARIA_search_question.png)
:::
:::::

## ARIA : résultats d’une instruction de recherche

![Résultats de l'instruction *Search your library* présentée sur la diapo précédente.](img/ARIA_search_results.png)

## ARIA : analyse visuelle

![Glisser-déposer d’une annotation PDF de type zone dans la fenêtre d'instruction.](img/ARIA_glisser_deposer.png)
