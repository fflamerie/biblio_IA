...
Les résultats de ces tests sont [dans le dossier **tests_IA_reecriture** sur le dépôt GitHub du stage](https://github.com/fflamerie/biblio_IA/tree/main/docs/tests_IA_reecriture) ; ce dossier contient également les bibliographies PUR et APA7 créées avec Zotero.
...
-   Copier les références contenues dans [le fichier **Test_texte_to_bibtex.docx**](https://github.com/fflamerie/biblio_IA/blob/main/docs/tests_IA_conversion/Test_texte_to_bibtex.docx).
...
-   [le fichier **Test_excel_to_bibtex.xlsx**](https://github.com/fflamerie/biblio_IA/blob/main/docs/tests_IA_conversion/Test_excel_to_bibtex.xlsx),
...
:::aside
☝️ Au cas où ChatGPT aurait progressé depuis mes propres tests de cet été, j'ai conservé les références au format .bib qu'il m'avait alors fournies : [fichier Test_excel_to_bib_chatGPT20250806.bib](https://github.com/fflamerie/biblio_IA/blob/main/docs/tests_IA_conversion/Test_excel_to_bib_chatGPT20250806.bib).
:::
...
![Consulter la fiche ["Comparatif de PapersGPT, ARIA et ZotAI"](https://github.com/fflamerie/biblio_IA/blob/main/docs/Fiche_IAgen_Zotero.pdf)](img/comp_zotero_genIA.png)
...
Les invites, les réponses des IA et les fichiers CSL sont sur le dépôt GitHub du stage, dans  [le dossier **Tests IA et CSL**](https://github.com/fflamerie/biblio_IA/tree/main/docs/tests_IA_CSL).
