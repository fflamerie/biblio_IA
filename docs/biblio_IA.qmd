...
!["Fonctionnement des IA" dans le cours d'A. Bouchard - [@bouchard2025IARecherche]](img/ABouchart_fonctionnement_IA.png)

:::aside
Consulter en ligne l'infographie [Fonctionnement des IA](https://callisto-formation.fr/course/view.php?id=952#module-22173)
:::
...
### Mettre de l'IA dans sa bibliothèque Zotero

Exemples de 3 services  dans la fiche ["Comparatif de PapersGPT, ARIA et ZotAI"](https://github.com/fflamerie/biblio_IA/blob/main/docs/Fiche_IAgen_Zotero.pdf) : extension [ARIA](https://github.com/lifan0127/ai-research-assistant/), extension [PapersGPT](https://www.papersgpt.com/) et application dédiée [ZotAI](https://zotai.app/)… mais **ARIA et PapersGPT ne sont pas compatibles avec Zotero 8**.
...
-   Extension [Zotero GPT](https://github.com/MuiseDestiny/zotero-gpt) : fonctionnement très peu intuitif, interface partiellement et tickets quasi entièrement en chinois.
